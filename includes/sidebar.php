...
<div>
<h1 class="text-lg font-black text-[#1a237e] dark:text-white uppercase tracking-wider">FAST Uni</h1>
...
<a class="<?php echo $current_page == 'students.php' ? 'bg-[#1a237e] text-white shadow-lg shadow-indigo-900/20' : 'text-slate-600 hover:bg-indigo-50/50'; ?> rounded-lg mx-4 px-4 py-3 flex items-center gap-3 transition-all duration-300" href="<?php echo BASE_URL; ?>/pages/students.php">
